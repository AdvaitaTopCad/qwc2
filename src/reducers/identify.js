...
export default function identify(state = { tool: null }, action) {
    switch (action.type) {
        ...
        case IDENTIFY_RESPONSE: {
            ...
            return assign({}, state, {
                responses: [
                    ...responses,
                    { reqId, request, data, responseType, error },
                ],
            });
        }
        case IDENTIFY_EMPTY: {
        ...
        case SET_IDENTIFY_FEATURE_RESULT: {
            ...
            const data = {
                ...
                features: [
                    ...
                    assign({}, action.feature, {
                        id: `${action.layername}.${action.feature.id}`,
                    }),
                ],
            };
            return assign({}, state, {
